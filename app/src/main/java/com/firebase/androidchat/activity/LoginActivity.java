    ...
    private void userLogin(final String email, String password){
        mFirebase.authWithPassword(email, password, new Firebase.AuthResultHandler() {
            ...
            public void onAuthenticationError(FirebaseError firebaseError) {
                System.out.println("Cannot created user account cause "+firebaseError.getMessage() + " " + firebaseError.getDetails());
    ...
    private void userRegister(final String email, String password){
        mFirebase.createUser(email, password, new Firebase.ValueResultHandler<Map<String, Object>>() {
            ...
            public void onError(FirebaseError firebaseError) {
                System.out.println("Cannot created user account cause "+firebaseError.getMessage() + " " + firebaseError.getDetails());
                Toast.makeText(getBaseContext(), "Cannot create account, username already exist or network issue, please try again.", Toast.LENGTH_SHORT).show();
                showProgress(false);
            }
        });
    }
